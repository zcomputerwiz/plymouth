...
"""
from .script_objects import Hash, Number, NativeFunction
...
def setup_window_library(interpreter, renderer):
    ...
    window_obj = Hash({
        ...
        # TODO: Implement SetBackgroundTopColor and SetBackgroundBottomColor
        # This would require the renderer to support gradient backgrounds.
    })
